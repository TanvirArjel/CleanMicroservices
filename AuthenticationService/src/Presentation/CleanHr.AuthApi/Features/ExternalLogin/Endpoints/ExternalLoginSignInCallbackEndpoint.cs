...
namespace CleanHr.AuthApi.Features.ExternalLogin.Endpoints;
...
public class ExternalLoginSignInCallbackEndpoint : ExternalLoginEndpointBase
{
    ...
    public async Task<IActionResult> Get(string remoteError = null)
    {
        ...
        if (signInResult.Succeeded)
        {
            ...
            redirectUrl = QueryHelpers.AddQueryString(redirectUrl, "refreshToken", authResult.Value.RefreshToken);
