...
using CleanHr.EmployeeApi.Domain.Aggregates.Validators;
using CleanHr.EmployeeApi.Domain.Primitives;
...
public sealed class Employee : AggregateRoot
{
    ...
    /// </summary>
    /// <param name="departmentServiceClient">The instance of <see cref="IDepartmentServiceClient"/>.</param>
    ...
    public static async Task<Result<Employee>> CreateAsync(
        ...
        string phoneNumber)
    {
        ArgumentNullException.ThrowIfNull(departmentServiceClient);
        ...
        EmployeeDepartmentValidator departmentValidator = new(departmentServiceClient);
    ...
    public async Task<Result> SetDepartmentAsync(IDepartmentServiceClient departmentServiceClient, Guid departmentId)
    {
        ArgumentNullException.ThrowIfNull(departmentServiceClient);

        EmployeeDepartmentValidator validator = new(departmentServiceClient);
