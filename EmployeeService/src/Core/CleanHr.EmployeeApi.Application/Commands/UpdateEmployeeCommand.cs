...
internal class UpdateEmployeeCommandHandler(
    ...
    IDepartmentServiceClient departmentServiceClient) : IRequestHandler<UpdateEmployeeCommand, Result>
{
    ...
    private readonly IDepartmentServiceClient _departmentServiceClient = departmentServiceClient ?? throw new ArgumentNullException(nameof(departmentServiceClient));
    ...
    public async Task<Result> Handle(UpdateEmployeeCommand request, CancellationToken cancellationToken)
    {
        ...
        Result departmentResult = await employeeToBeUpdated.SetDepartmentAsync(_departmentServiceClient, request.DepartmentId);
