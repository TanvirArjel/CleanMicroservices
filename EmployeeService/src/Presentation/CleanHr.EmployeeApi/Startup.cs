...
using CleanHr.EmployeeApi.Extensions;
using CleanHr.EmployeeApi.Filters;
using CleanHr.EmployeeApi.Utilities;
using CleanHr.EmployeeApi.Application.Commands;
using CleanHr.EmployeeApi.Domain.Aggregates;
using CleanHr.EmployeeApi.Infrastructure.Services;
using CleanHr.EmployeeApi.Persistence.Cache;
using CleanHr.EmployeeApi.Persistence.RelationalDB.Extensions;
...
internal static class Startup
{
    ...
    public static void ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        // Register IDepartmentServiceClient for HTTP calls to DepartmentService
        services.AddHttpClient<IDepartmentServiceClient, DepartmentServiceClient>(client =>
        {
            client.BaseAddress = new Uri("http://localhost:5200"); // DepartmentService URL
        ...
        services.AddSwaggerGeneration("Clean HR Employee Service", "CleanHr.EmployeeApi");

        // TODO: JWT authentication can be configured if needed for securing endpoints
