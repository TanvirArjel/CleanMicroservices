...
public sealed class UpdateDepartmentCommand : IRequest<Result>
{
    public UpdateDepartmentCommand(Guid id, string name, string description, bool isActive)
    {
        Id = id;
        Name = name;
    ...
    private sealed class UpdateDepartmentCommandHandler : IRequestHandler<UpdateDepartmentCommand, Result>
    {
